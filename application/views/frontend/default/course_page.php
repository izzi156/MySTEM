  ...
  <div class="container">
    <div class="row">
      ...
      <div class="preview-video-box">
        ...
        <a href=<?php echo $this->crud_model->get_course_video_url($param1 = ""); ?> target="_blank">
        <img class="fill" src="<?php echo $this->crud_model->get_course_thumbnail_url($course_details['id']); ?>" alt="" class="img-fluid">
...
<div class="col-lg-4">
  <!-- <div class="course-sidebar natural">
    <?php //if ($course_details['video_url'] != ""): ?>
      <div class="preview-video-box">
        <a data-toggle="modal" data-target="#CoursePreviewModal">
        <a href=<?php //echo $this->crud_model->get_course_video_url($param1 = ""); ?> target="_blank"><img src="<?php //echo $this->crud_model->get_course_thumbnail_url($course_details['id']); ?>" alt="" class="img-fluid">
           <span class="preview-text"><?php //echo get_phrase('preview_this_course'); ?></span>
          <span class="play-btn"></span></a>
        </a>
      </div> -->
