                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <?php if (get_settings('allow_instructor') == 1): ?>
                        <div class="instructor-box menu-icon-box">
                            <div class="icon">
                                <a href="<?php echo site_url('user'); ?>" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0;"><?php echo get_phrase('teacher'); ?></a>
                            </div>
                        </div>
                    <?php elseif (get_settings('allow_student') == 1): ?>
                        <div class="student-box menu-icon-box">
                            <div class="icon">
                                <a href="<?php echo site_url('student'); ?>" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0;"><?php echo get_phrase('student'); ?></a>
                            </div>
                        </div>
                    <?php endif; ?>
