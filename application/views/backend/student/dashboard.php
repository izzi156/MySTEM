    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title"><?php echo get_phrase('Dashboard'); ?></h4>
        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('student/enrol_history'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                    ...
                    <!-- <div class="col-sm-6 col-xl-3">
                        <a href="<?php //echo site_url('student/users'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
