	...
	<!--- Sidemenu -->
		<ul class="metismenu side-nav side-nav-light">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/students'); ?>" class="side-nav-link <?php if ($page_name == 'students' || $page_name == 'student_add' || $page_name == 'student_edit')echo 'active';?>">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/homeworks'); ?>" class="side-nav-link <?php if ($page_name == 'report' || $page_name == 'invoice')echo 'active';?>">
					<i class="dripicons-media-shuffle"></i>
