    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('user/students/edit/'.$user_id); ?>" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="d-flex">
                                                  <div class="">
                                                      <img class = "rounded-circle img-thumbnail" src="<?php echo $this->user_model->get_student_image_url($user_data['id']);?>" alt="" style="height: 50px; width: 50px;">
                                                  </div>
